...
CustomController::CustomController(DataContainer &dc, RobotData &rd) : dc_(dc), rd_(rd), wbc_(dc.wbc_)
{
    ...
    pedal_command = dc_.nh.subscribe("/tocabi/pedalcommand", 100, &CustomController::PedalCommandCallback, this); //MJ
...
ofstream MJ_graph("/home/dyros_rm/DG/data/MJ_graph.txt");
...
void CustomController::getCOMTrajectory_dg()
{
...
Eigen::VectorQd CustomController::gravityCompensator(WholebodyController &wbc, Eigen::VectorQd current_q)
{
	...
	if(foot_swing_trigger_ == true)
	{
		if(walking_phase_<= dsp_ratio_)
		{
			...
			contact_redist_torque = wbc.contact_force_redistribution_torque_walking(rd_, torque_g_dsp, A, B, contact_ratio, support_foot);
...
void CustomController::getZmpTrajectory_dg()
{
       ...
       Eigen::MatrixXd Gi, Eigen::VectorXd Gd, Eigen::MatrixXd Gx, Eigen::MatrixXd A, Eigen::VectorXd B, Eigen::MatrixXd C, Eigen::Vector3d &XD, Eigen::Vector3d &YD)
{
    ...
    {
        preview_x_b_mj.setZero(); preview_y_b_mj.setZero();
        preview_x_mj.setZero(); preview_y_mj.setZero();
    ...
    {     
        preview_x_mj = xs; preview_y_mj = ys;
...
void CustomController::getComTrajectory()
{
  if(walking_tick_mj == 0)  
  {
    Gi_mj_.setZero(); Gx_mj_.setZero(); Gd_mj_.setZero();
    preview_Parameter(1.0/hz_, 16*hz_/10, Gi_mj_, Gd_mj_, Gx_mj_, A_mj_, B_mj_, C_mj_);
    xs_mj_(0) = xi_mj_; xs_mj_(1) = 0; xs_mj_(2) = 0;
    ys_mj_(0) = yi_mj_; ys_mj_(1) = 0; xs_mj_(2) = 0;
    UX_mj_ = 0; UY_mj_ = 0;
    xd_mj_ = xs_mj_;
  }
...
void CustomController::updateNextStepTime()
{
   ...
   {
     walking_enable_ = false; cout << "Last " << pelv_float_init_.translation()(0) << "," << lfoot_float_init_.translation()(0) << "," << rfoot_float_init_.translation()(0) << "," << pelv_rpy_current_mj_(2)*180/3.141592 << endl;
   }
   walking_tick_mj ++;
}
